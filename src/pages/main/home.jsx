...
const slides = [
    ...
    },
    {
        ...
        'bg_color': '#422600',
        'title': 'Wines Store',
        'content': 'Discover our collection of rich and robust red wines, perfect for any occasion. \nCrisp and refreshing, our whites wines are ideal for pairing with your favourite meals. Celebrate with our selection of wines.',
    },
]
...
function Home(){
    return (
        <section className="mx-5 xs:mx-10 lg:mx-20 mb-5 my-10">
            <section className="flex flex-col lg:flex-row">
                ...
                <div className="border-2 mt-5 h-[310px] xs:h-[400px] lg:h-auto lg:mt-0 border-gray-300 grow mx-2 rounded-xl overflow-hidden">
